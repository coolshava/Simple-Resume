...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{multicol}
% Lets me split up Skills in columns to save space.
\begin{document}
...
%{7220 McCallum Blvd Apt 2103, Dallas, TX 75252}
%\href{https://www.google.com/maps/place/205+Longleaf+Court,+Orlando,+Florida+32835,+USA}
%{205 Longleaf Ct, Orlando Florida 32835}
Orlando, FL
\, \SubBulletSymbol\, 
Dallas, TX 
%\SubBulletSymbol \href{https://github.com/coolshava}{https://github.com/coolshava}
...
%(and \href{https://be.utdallas.edu}{Biomedical Engineering})
\hfill
Total GPA: 3.18 / 4.00
%\Gap
\BulletItem
...
%\SubBulletItem 
%Experience with slicers for 3D printing STL files, including \textbf{Netfabb}.
...
%\SubBulletItem
%Basic scripting capacities in \textbf{Python}
\SubBulletItem
...
Richardson, TX
\hfill
\DatestampYMD{2019}{1}{18} -- \DatestampYM{2019}{5}
\SmallGap
...
\begin{Detail}
\SubBulletItem
%Provided solutions to nonprofits. 
...
\hfill
\DatestampYM{2018}{01} -- \DatestampYM{2018}{05}
\par
\begin{Detail}
\SubBulletItem
...
\hfill
\DatestampYM{2017}{08} -- \DatestampYM{2017}{12}
%\par
\begin{Detail}
\SubBulletItem
...
\hfill
\DatestampYM{2016}{08} -- \DatestampYM{2017}{5}
\BulletItem
...
\Entry
%Academic and Music Tutoring and Volunteering
%\BulletItem
%Skills: Communication Skills, pedagogical techniques, community building
\Entry
